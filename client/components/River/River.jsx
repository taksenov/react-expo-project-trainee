...
class River extends React.Component {
    render() {
        ...
        if (
            level >= AppConstants.CRITICAL_LEVEL_PASHTORY - 10 &&
            level <= AppConstants.CRITICAL_LEVEL_PASHTORY
        ) {
            tableColorClass = 'info';
        } else if (
            level > AppConstants.CRITICAL_LEVEL_PASHTORY &&
            level <= AppConstants.CRITICAL_LEVEL_TUGIYANY
        ) {
        ...
        return (
            <tr className={(riverClass += tableColorClass)}>
                ...
                <td>
                    <span
                        className="glyphicon glyphicon-pencil River__action-icon hidden-xs hidden-sm"
                        aria-hidden="true"
                        onClick={() => console.log('Edit River')}
                    />
                    <span
                        className="glyphicon glyphicon-remove River__action-icon"
                        aria-hidden="true"
